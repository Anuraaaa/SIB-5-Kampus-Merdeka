            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/anwar2.jpg"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10">Muhammad Anwar Fauzan</h4>
                                    <h6 class="card-subtitle">Fullstack Developer</h6>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Muhammad Anwar Fauzan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" placeholder="anwarfauzan75@gmail.com"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="+6259-3941-0330"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
