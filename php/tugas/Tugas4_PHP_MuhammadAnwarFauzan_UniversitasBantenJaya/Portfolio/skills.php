    ...
    <div class="colorlib-narrow-content">
        ...
        <div class="row">
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                <p>
                    I have a variety of skills that I have developed with time and experience. These skills not only enable me to succeed in a variety of projects and challenges, but also strengthen my contribution in the work environment                    
                </p>
            </div>
